        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EcosystemsDetected = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecurityGrade = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiFixSuggestion = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeIssues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CodeIssues_ScanResults_ScanResultId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SafeVersion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Severity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VulnerablePackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VulnerablePackages_ScanResults_ScanResultId",
                        column: x => x.ScanResultId,
                        principalTable: "ScanResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeIssues_ScanResultId",
                table: "CodeIssues",
                column: "ScanResultId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VulnerablePackages_ScanResultId",
                table: "VulnerablePackages",
                column: "ScanResultId");
        }
